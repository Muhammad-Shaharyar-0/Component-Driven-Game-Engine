...
struct Transform
{
	Datastructers::Matrix4x4 mTransform = Datastructers::TranslationMatrix(mTranslation)* Datastructers::ScaleMatrix(Datastructers::Vector4(0.1f, 0.1f, 0.1f, 1.0f));
	...
	Datastructers::Vector4 mScale = Datastructers::Vector4(1, 1, 1, 1.0f);
